    ...
    <div id="about" className="py-16 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-maroon dark:text-cream sm:text-4xl">
            About Our School
          </h2>
          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="text-left bg-cream dark:bg-gray-800 p-6 rounded-lg shadow-lg">
