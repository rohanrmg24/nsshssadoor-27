...
const Navbar = () => {
  ...
  return (
    <nav className="bg-maroon/90 backdrop-blur-sm text-cream fixed w-[95%] z-50 top-4 left-1/2 -translate-x-1/2 rounded-xl transition-all duration-300 shadow-lg border border-gray-200 dark:border-gray-700">
