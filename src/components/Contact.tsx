    ...
    <div id="contact" className="py-16 bg-cream dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border-2 border-maroon dark:border-cream hover:scale-105 transition-transform duration-300 animate-fade-in">
          ...
          <div className="rounded-lg overflow-hidden shadow-lg border-2 border-maroon dark:border-cream hover:scale-105 transition-transform duration-300 animate-fade-in">
            <iframe
